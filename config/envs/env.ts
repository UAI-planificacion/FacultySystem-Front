...
const envSchema = z.object({
    ...
    NEXT_PUBLIC_ACADEMIC_ENDPOINT_SECTIONS: z.string().min(1),
...
const processEnv = {
    ...
    NEXT_PUBLIC_ACADEMIC_ENDPOINT_SECTIONS        : process.env.NEXT_PUBLIC_ACADEMIC_ENDPOINT_SECTIONS,
...
export const ENV = {
    ...
    ENDPOINT_SECTIONS   : parsedEnv.data.NEXT_PUBLIC_ACADEMIC_ENDPOINT_SECTIONS,
